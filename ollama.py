...
def ask_ollama(selected_feature,max_value,min_value,max_district,min_district):
    data = {
        "model": "llama3.1:latest",
        "prompt": f"The feature selected is {selected_feature}. The district with the maximum {selected_feature} is {max_district} with the value {max_value} , and the district with the minimum is {min_district} with the value {min_value}. Can you analyze these findings in the context of Germany's districts and give a short response in 5-10 lines?"
    }
    headers = {
